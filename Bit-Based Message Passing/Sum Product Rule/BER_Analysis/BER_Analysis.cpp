...
int main(void)
{
	...
	start = time(NULL);
	printf("EXIT Chart & BER Analysis of Bit-based Message Passing in MIMO Channel\n");
	...
	fprintf(records, "EXIT Chart & BER Analysis of Bit-based Message Passing in MIMO Channel\n");
