...
plot(Func_exit_5(:,2), Func_exit_5(:,3), '-gx',  'LineWidth', 2.0, 'MarkerSIze', 10);
plot(Bit_exit_5(:,2), Bit_exit_5(:,1), '-ro',  'LineWidth', 2.0, 'MarkerSIze', 10);
plot(Bit_exit_5(:,3), Bit_exit_5(:,1), '-cv',  'LineWidth', 2.0, 'MarkerSIze', 10);
plot(0, 1, 'w');
