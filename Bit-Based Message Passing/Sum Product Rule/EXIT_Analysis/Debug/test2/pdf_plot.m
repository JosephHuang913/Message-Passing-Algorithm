...
axis([-20 20 0 0.25]);
legend('E_b/N_0 = 10 dB', 'E_b/N_0 = 10 dB', 'E_b/N_0 = 15 dB', 'E_b/N_0 = 15 dB', 'I_a_,_i_n = 0.5');
...
title('Probability Density Function of Output Decision Information (Bit Node)');
xlabel('LLR_E');
ylabel('Probability Density Function (pdf)');
axis([-20 20 0 0.15]);
legend('E_b/N_0 = 10 dB', 'E_b/N_0 = 10 dB', 'E_b/N_0 = 15 dB', 'E_b/N_0 = 15 dB', 'I_a_,_i_n = 0.5');
