...
figure(1);
set(gca, 'fontsize', 14);
plot(Func_exit(:,2), Func_exit(:,3), '-r*',  'LineWidth', 2.0, 'MarkerSIze', 10);
hold on;
grid on;
plot(Bit_exit(:,2), Bit_exit(:,1), '-b^',  'LineWidth', 2.0, 'MarkerSIze', 10);
plot(Bit_exit(:,3), Bit_exit(:,1), '-ms',  'LineWidth', 2.0, 'MarkerSIze', 10);
plot(0, 1, 'w');
...
legend('Function Node', 'Bit Node', 'Decision Node', '5 dB', 2);
%print -djpeg100 EXIT_Bit_Message_Passing_MIMO_5.jpg;