...
title('EXIT Chart of Message Passing Algorithm in MIMO Fading Channel');
xlabel('(I_A_,_C_N_D,  I_E_,_B_N_D,  I_D)');
ylabel('(I_E_,_C_N_D,  I_A_,_B_N_D,  I_A_,_B_N_D)');
axis([0 1 0 1]);

legend('Channel Node', 'Bit Node', 'Decision Variable', '10 dB', 2);
%print -djpeg100 EXIT_Bit_Message_Passing_MIMO_10.jpg;
...
legend('Channel Node (10 dB)', 'Bit Node (10 dB)', 'Decision Variable (10 dB)', 'Channel Node (15 dB)', 'Bit Node (15 dB)', 'Decision Variable (15 dB)', 2);
