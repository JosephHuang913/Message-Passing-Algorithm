...
semilogy(ber_Bit_based_Message_Passing(:,1), ber_Bit_based_Message_Passing(:,11), '-mx',  'LineWidth', 2.0, 'MarkerSIze', 12);
% semilogy(ber_Bit_based_Message_Passing(:,1), ber_Bit_based_Message_Passing(:,12), '-c*',  'LineWidth', 2.0, 'MarkerSIze', 12);
% semilogy(ber_Bit_based_Message_Passing(:,1), ber_Bit_based_Message_Passing(:,13), '-r*',  'LineWidth', 2.0, 'MarkerSIze', 12);
% semilogy(ber_Bit_based_Message_Passing(:,1), ber_Bit_based_Message_Passing(:,14), '-ms',  'LineWidth', 2.0, 'MarkerSIze', 10);
% semilogy(ber_Bit_based_Message_Passing(:,1), ber_Bit_based_Message_Passing(:,15), '-g^',  'LineWidth', 2.0, 'MarkerSIze', 10);
% semilogy(ber_Bit_based_Message_Passing(:,1), ber_Bit_based_Message_Passing(:,16), '-k*',  'LineWidth', 2.0, 'MarkerSIze', 12);
% semilogy(ber_Bit_based_Message_Passing(:,1), ber_Bit_based_Message_Passing(:,17), '-yx',  'LineWidth', 2.0, 'MarkerSIze', 12);
% semilogy(ber_Bit_based_Message_Passing(:,1), ber_Bit_based_Message_Passing(:,18), '-bs',  'LineWidth', 2.0, 'MarkerSIze', 10);
% semilogy(ber_Bit_based_Message_Passing(:,1), ber_Bit_based_Message_Passing(:,19), '-cx',  'LineWidth', 2.0, 'MarkerSIze', 12);
% semilogy(ber_Bit_based_Message_Passing(:,1), ber_Bit_based_Message_Passing(:,20), '-rs',  'LineWidth', 2.0, 'MarkerSIze', 10);
semilogy(ber_Bit_based_Message_Passing(:,1), ber_Bit_based_Message_Passing(:,21), '-bs',  'LineWidth', 2.0, 'MarkerSIze', 10);
...
legend('Bit-Based Message Passing', '3_r_d Iteration', '5_t_h Iteration', '10_t_h Iteration', '20_t_h Iteration', 'MAP EQ (QPSK)', 3);
