...
/*
const float H_I[4][4] = {{0.926, -0.24, 1.305, 0.483},	// Channel matrix
								 {-0.432, 0.448, -0.32, 0.507},
                         {-0.211, 0.649, 0.316, -0.969},
                         {-0.198, -1.054, 0.44, 0.948}
								};
const float H_Q[4][4] = {{-1.187, -0.535, 0.184, -0.852},
								 {-0.235, 0.122, -0.007, 0.417},
                         {-0.877, 0.294, -0.209, -0.312},
                         {-0.688, 0.14, 0.371, -0.304}
								};
  */
...
/*======================*/
	ber=fopen("ber_Bit_based_Message_Passing.log", "w");
