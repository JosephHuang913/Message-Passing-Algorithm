...
axis([-20 20 0 0.25]);
legend('E_b/N_0 = 15 dB', 'E_b/N_0 = 15 dB', 'I_A = 0.5');
%legend('E_b/N_0 = 10 dB', 'E_b/N_0 = 10 dB', 'E_b/N_0 = 15 dB', 'E_b/N_0 = 15 dB', 'I_A = 0.5');
...
figure(3);
set(gca, 'fontsize', 14);
plot(LLR_pdf(1:10000,3), LLR_pdf(1:10000,8), ':m',  'LineWidth', 2.0, 'MarkerSIze', 10);
hold on;
grid on;
plot(LLR_pdf(1:10000,3), LLR_pdf(1:10000,9), ':g',  'LineWidth', 2.0, 'MarkerSIze', 10);

% plot(LLR_pdf(10001:20000,3), LLR_pdf(10001:20000,8), '-r',  'LineWidth', 2.0, 'MarkerSIze', 10);
% hold on;
% grid on;
% plot(LLR_pdf(10001:20000,3), LLR_pdf(10001:20000,9), '-b',  'LineWidth', 2.0, 'MarkerSIze', 10);
% plot(0, 0, 'w');

title('Probability Density Function of Decision Information (Bit Node)');
xlabel('LLR_E');
ylabel('Probability Density Function (pdf)');
axis([-100 100 0 0.1]);
legend('E_b/N_0 = 15 dB', 'E_b/N_0 = 15 dB', 'I_A = 0.5');
%legend('E_b/N_0 = 10 dB', 'E_b/N_0 = 10 dB', 'E_b/N_0 = 15 dB', 'E_b/N_0 = 15 dB', 'I_A = 0.5');
%print -djpeg100 pdf_LLR_D.jpg;
