...
semilogy(BER_Bit_based_Message_Passing(1:6,1), BER_Bit_based_Message_Passing(1:6,2), '-ro',  'LineWidth', 2.0, 'MarkerSIze', 10);
hold on;
grid on;
semilogy(BER_Bit_based_Message_Passing(1:6,1), BER_Bit_based_Message_Passing(1:6,3), '-mx',  'LineWidth', 2.0, 'MarkerSIze', 12);
...
semilogy(BER_Bit_based_Message_Passing(1:6,1), BER_Bit_based_Message_Passing(1:6,7), '-g*',  'LineWidth', 2.0, 'MarkerSIze', 10);
plot(0, 1, 'w');
...
legend('1_s_t Iteration', '2_n_d Iteration', '3_r_d Iteration', '4_t_h Iteration', '5_t_h Iteration', '6_t_h Iteration', 'QPSK, VA500', 3);
