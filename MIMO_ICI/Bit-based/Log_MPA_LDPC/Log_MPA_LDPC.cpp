...
{
	time_t  ti, start, end;
	int i, j, q, l, m, p, r/*, s1*/, s2/*, s3*/, x, z, t, d, *data, **data_bit, **Ak, *S_random;
	...
	long double *gain, ****fade/*, *****fade, ***F_l, ****H_I, ****H_Q, ***Est_sym_I, ***Est_sym_Q*/;
	long double /**Re_ICI_I, **Re_ICI_Q, ***Re_signal, **Sk,*/ ***H_f, *fft;
...
/*
				...
				for(t=0; t<N_fft; t++)
				{
					for(j=0; j<Mc*T; j++)
						// Bit Soft Decision
            			Sk[t][j] = tanhl(0.5*logl(Out[t][j][1]/Out[t][j][0]));
