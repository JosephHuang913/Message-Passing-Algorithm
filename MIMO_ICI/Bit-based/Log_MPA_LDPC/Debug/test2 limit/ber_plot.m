...
hold on;
grid on;
semilogy(BER_MPA_LDPC(:,1), BER_MPA_LDPC(:,3), '-md',  'LineWidth', 2.0, 'MarkerSIze', 10);
...
legend('1_s_t Iteration', '2_n_d Iteration', '3_r_d Iteration', '10_t_h Iteration', 'QPSK, VA120', 3);
