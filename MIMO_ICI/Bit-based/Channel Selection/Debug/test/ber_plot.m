...
hold on;
grid on;
%semilogy(BER_MPA_LDPC(:,1), BER_MPA_LDPC(:,3), '-.k',  'LineWidth', 2.0, 'MarkerSIze', 12);
semilogy(BER_MPA_LDPC(:,1), BER_MPA_LDPC(:,4), '-c*',  'LineWidth', 2.0, 'MarkerSIze', 12);
%semilogy(BER_MPA_LDPC(:,1), BER_MPA_LDPC(:,5), '-.k',  'LineWidth', 2.0, 'MarkerSIze', 10);
semilogy(BER_MPA_LDPC(:,1), BER_MPA_LDPC(:,6), '-g^',  'LineWidth', 2.0, 'MarkerSIze', 10);
%semilogy(BER_MPA_LDPC(:,1), BER_MPA_LDPC(:,7), '-.k',  'LineWidth', 2.0, 'MarkerSIze', 12);
semilogy(BER_MPA_LDPC(:,1), BER_MPA_LDPC(:,8), '-mx',  'LineWidth', 2.0, 'MarkerSIze', 12);
%semilogy(BER_MPA_LDPC(:,1), BER_MPA_LDPC(:,9), '-.k',  'LineWidth', 2.0, 'MarkerSIze', 10);
%semilogy(BER_MPA_LDPC(:,1), BER_MPA_LDPC(:,10), '-.k',  'LineWidth', 2.0, 'MarkerSIze', 12);
semilogy(BER_MPA_LDPC(:,1), BER_MPA_LDPC(:,11), '-bs',  'LineWidth', 2.0, 'MarkerSIze', 10);
