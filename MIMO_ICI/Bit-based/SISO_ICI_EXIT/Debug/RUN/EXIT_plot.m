...
title('EXIT Chart of Bit-based Message Passing Algorithm in ICI Channel');
xlabel('I_A_,_F_N_D,  I_E_,_B_N_D');
ylabel('I_E_,_F_N_D,  I_A_,_B_N_D');
axis([0 1 0 1]);

legend('Function Node, 15dB', 'Function Node, 25dB', 'Bit Node', 2);
%print -djpeg100 EXIT_Bit_Message_Passing_ICI.jpg;
